...
const Update = () => {
    const { stateUpdate, handleCloseDialog, handleFullscreenDialog, updateMicroinverter } =
        useMicroinverters();
    ...
    return (
        ...
        >
            <Header id="draggable-dialog-title" fullScreen={stateUpdate.fullscreen}>
                <Title>Actualizar microinversor</Title>
                <Actions>
