    ...
    return (
        <Container>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                ...
                <g id="freepik--Planets--inject-14">
                    <g style={{ opacity: 0.30000000000000004 }}>
                        <path
                            ...
                            style={{ fill: "#5c7acb" }}
                        />
                        <circle cx="72.97" cy="216.13" r="1.32" style={{ fill: "#5c7acb" }} />
                        <circle cx="291.05" cy="408.33" r="1.89" style={{ fill: "#5c7acb" }} />
                        <circle cx="336.5" cy="332" r="1.32" style={{ fill: "#5c7acb" }} />
                        <path
                        ...
                        <path
                            ...
                            style={{ fill: "#5c7acb" }}
                        />
                        <circle cx="277.7" cy="136.94" r="1.32" style={{ fill: "#5c7acb" }} />
                    </g>
                    <circle cx="141.23" cy="116.36" r="21.91" style={{ fill: "#5c7acb" }} />
                    <circle
                        cx="141.23"
                        cy="116.36"
                        r="21.91"
                ...
                <g id="freepik--Astronaut--inject-14">
                    ...
                    <path
                        ...
                        style={{ fill: "#5c7acb", opacity: 0.30000000000000004 }}
                    />
                    <path
                    ...
                    <path
                        ...
                        style={{ fill: "#5c7acb", opacity: 0.6000000000000001 }}
                    />
                    <path
                ...
                <g id="freepik--Rocket--inject-14">
                    ...
                    <circle cx="222.2" cy="282.18" r="8.29" style={{ fill: "#5c7acb" }} />
                    <polygon
            ...
            <TextContainer>
                ...
                <Subtitle>La página que estás buscando no existe.</Subtitle>
            </TextContainer>
